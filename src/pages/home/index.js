...
const Home = () => {
    ...
    return (
        <>
            <Dashboardlayout>
                <div className="xl:px-8 md:px-4 py-6 w-full">
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-bold font-plus">Explore</h2>
                        <ul >
                            <li className=" inline-block mx-1">
                                <div className="flex items-center lg:gap-2 gap-1 cursor-pointer py-2 lg:px-5 px-3 bg-white rounded-full border border-[#38579E]">
                    ...
                    <div className="lg:flex mt-5 gap-3 justify-between">
                        ...
                        <div className="xl:max-w-[810px] lg:max-w-xl md:max-w-[740px] sm:max-w-[610px] mx-auto lg:mx-0 ">
