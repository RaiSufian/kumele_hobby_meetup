...
const Slider3 = () => {
  return (
    <div className="max-w-6xl mx-auto xl:py-2 py-2 xl:mt-2">
      <div className='flex xl:py-12 py-8 gap-20 lg:px-2'>
        ...
        <div className='w-1/2 text-start'>
          <h2 className='xl:text-3xl text-xl font-fredoka font-medium relative z-0 after:absolute after:top-full after:left-52 after:bg-theme after:h-3 after:w-32 after:-z-10 after:-translate-y-3'>Get Matched in 48 hours</h2>
          ...
          <div className='text-center xl:mt-5 mt-2'>
