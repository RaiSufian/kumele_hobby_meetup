                                                ...
                                                <h6 className={` flex gap-1 items-center ${styleMode ? "text-white" : " "} `}>Dislikes
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 33 32" fill="none">
                                                        <g clip-path="url(#clip0_1040_2851)">
                                                            <path opacity="0.35" d="M27.2674 9.22C26.5901 6.17067 23.8848 4 20.7594 4H11.4408C8.49542 4 6.10742 6.388 6.10742 9.33333V18.6667C6.10742 20.056 6.81676 21.2773 7.89276 21.9947L11.7048 29.6333C12.1648 30.5547 13.2848 30.9293 14.2074 30.4693C16.3168 29.4173 17.3008 26.9493 16.4954 24.7333L15.7421 22.6667H24.7741C26.9834 22.6667 28.7741 20.876 28.7741 18.6667V16L27.2674 9.22Z" fill="black" />
                                                            <path d="M7.44344 6C7.44344 6.51467 7.44344 20.152 7.44344 20.6667C7.44344 21.7707 5.94936 22.6667 4.10844 22.6667C2.26752 22.6667 0.773438 21.7707 0.773438 20.6667C0.773438 20.152 0.773438 6.51467 0.773438 6C0.773438 4.896 2.26752 4 4.10844 4C5.94936 4 7.44344 4.896 7.44344 6Z" fill="black" />
                                                        </g>
                                                        <defs>
                                        ...
                                        <li className="flex items-start gap-2 mt-3 cursor-pointer" onClick={() => openModal("Male")}>
                                            ...
                                            <div>
                                                <h6 className={` flex gap-1 items-center ${styleMode ? "text-white" : " "} `}>Male
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 33 32" fill="none">
                                                            <path opacity="0.35" d="M23.4408 20H10.1074V25.3333H23.4408V20Z" fill="black" />
                                                            <path opacity="0.35" d="M16.7741 16.0013C20.456 16.0013 23.4408 13.0165 23.4408 9.33463C23.4408 5.65274 20.456 2.66797 16.7741 2.66797C13.0922 2.66797 10.1074 5.65274 10.1074 9.33463C10.1074 13.0165 13.0922 16.0013 16.7741 16.0013Z" fill="black" />
                                                            <path d="M28.6976 23.208C28.3336 21.308 26.5643 20 24.6296 20H22.1069V24L16.7736 21.3333L11.4403 24V20H10.1083C6.98293 20 5.2136 21.308 4.8496 23.208C4.35893 25.764 6.3056 28 8.7736 28H24.7736C27.2416 28 29.1883 25.764 28.6976 23.208Z" fill="black" />
                                                        </svg>
                                                    </span>
                                                </h6>
                                            </div>
                                        ...
                                        <li className="flex items-start gap-2 mt-3 cursor-pointer" onClick={() => openModal("Non-Binary")}>
                                            ...
                                            <div>
                                                <h6 className={` flex gap-1 items-center ${styleMode ? "text-white" : " "} `}>Non-Binary
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 33 32" fill="none">
                                                            <path opacity="0.35" d="M22.1061 16H11.4395V28H22.1061V16Z" fill="black" />
                                                            <path opacity="0.35" d="M22.1074 12C24.3166 12 26.1074 10.2091 26.1074 8C26.1074 5.79086 24.3166 4 22.1074 4C19.8983 4 18.1074 5.79086 18.1074 8C18.1074 10.2091 19.8983 12 22.1074 12Z" fill="black" />
                                                            <path opacity="0.35" d="M11.4395 12C13.6486 12 15.4395 10.2091 15.4395 8C15.4395 5.79086 13.6486 4 11.4395 4C9.23031 4 7.43945 5.79086 7.43945 8C7.43945 10.2091 9.23031 12 11.4395 12Z" fill="black" />
                                                            <path d="M23.4401 14.668H10.1068C7.16144 14.668 4.77344 17.056 4.77344 20.0013V22.668C4.77344 25.6133 7.16144 28.0013 10.1068 28.0013H12.7734V26.668C12.7734 25.1946 13.9668 24.0013 15.4401 24.0013H18.1068C19.5801 24.0013 20.7734 25.1946 20.7734 26.668V28.0013H23.4401C26.3854 28.0013 28.7734 25.6133 28.7734 22.668V20.0013C28.7734 17.056 26.3854 14.668 23.4401 14.668ZM16.7734 22.668C15.3001 22.668 14.1068 21.4746 14.1068 20.0013C14.1068 18.528 15.3001 17.3346 16.7734 17.3346C18.2468 17.3346 19.4401 18.528 19.4401 20.0013C19.4401 21.4746 18.2468 22.668 16.7734 22.668Z" fill="black" />
                            ...
                            <div className="w-1/2 h-9 sm:text-lg text-base font-plus font-medium flex items-center gap-1 justify-center cursor-pointer" onClick={() => { setEvents("futrue") }}>
                                ...
                                <div className="relative">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="19" viewBox="0 0 24 28" fill="none">
                                        <path d="M8.19531 24C8.19531 26.12 9.91265 27.8373 12.0326 27.8373C14.1526 27.8373 15.87 26.12 15.87 24H8.19531Z" fill="black" />
                                        ...
                                        <path d="M14.6673 2.66667V4.38667C13.8273 4.13333 12.934 4 12.0007 4C11.0673 4 10.174 4.13333 9.33398 4.38667V2.66667C9.33398 1.2 10.534 0 12.0007 0C13.4673 0 14.6673 1.2 14.6673 2.66667Z" fill="black" />
                                    </svg>
                ...
                <div className={` ${styleMode ? "bg-black" : "bg-white "} modal p-10 rounded-3xl relative `} >
                    ...
                    <div className="absolute top-5 right-5 cursor-pointer" onClick={() => setDataown(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="33" viewBox="0 0 44 44" fill="none">
                            <path opacity="0.35" d="M30.1767 8.76722C29.8267 9.11544 25.3247 13.6192 22.1179 16.826C18.9111 13.6192 14.4091 9.11722 14.0591 8.76722C12.6716 7.37967 10.4224 7.37967 9.0348 8.76722C7.64725 10.1548 7.64725 12.404 9.0348 13.7915C9.38302 14.1415 13.8868 18.6435 17.0936 21.8503C13.8868 25.0572 9.3848 29.5592 9.0348 29.9091C7.64725 31.2967 7.64725 33.5459 9.0348 34.9335C10.4224 36.321 12.6716 36.321 14.0591 34.9335C14.3114 34.6812 34.9488 14.0438 35.201 13.7915C36.5886 12.404 36.5886 10.1548 35.201 8.76722C33.8135 7.37967 31.5643 7.37967 30.1767 8.76722Z" fill="black" />
                            <path d="M35.2003 34.9347C36.5879 33.5471 36.5879 31.2979 35.2003 29.9104C34.8521 29.5621 30.3483 25.0584 27.1415 21.8516L22.1172 26.8759C25.324 30.0827 29.826 34.5847 30.176 34.9347C31.5635 36.3222 33.8128 36.3222 35.2003 34.9347Z" fill="black" />
                        </svg>
                    </div>
                </div>
            </div> : null}
