    ...
    return (
        <Dashboardlayout >
            <div className={` ${styleMode ? " bg-black" : " layout_bg"} md:mx-4 mx-2 mb-4 pb-4  rounded-lg font-plus `} >
                ...
                <div className={`my-4 md:mx-4 mx-1 font-plus xl:max-w-5xl xl:mx-auto rounded-lg py-2 lg:py-4 sm:px-4 px-1 xl:px-14 ${styleMode ? " bg-black" : " bg-white"} `}>
                        ...
                        <div className="px-2 font-plus">
                            <div className={`${styleMode ? "text-white" : ""} `}>
                                ...
                                <div className={`${styleMode ? "text-white" : ""} mt-4`}>
                                    <div className="flex gap-2">
                                        <div className="w-1/3">
                                            ...
                                            <button className="flex bg-black text-white items-center gap-1 h-11 px-3 rounded-md mt-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="36" viewBox="0 0 45 46" fill="none">
                                                    <path opacity="0.35" d="M35.625 38H9.375C6.26813 38 3.75 35.4819 3.75 32.375V13.625C3.75 10.5181 6.26813 8 9.375 8H35.625C38.7319 8 41.25 10.5181 41.25 13.625V32.375C41.25 35.4819 38.7319 38 35.625 38Z" fill="white" />
                                                    <path d="M31.875 19.25C33.9461 19.25 35.625 17.5711 35.625 15.5C35.625 13.4289 33.9461 11.75 31.875 11.75C29.8039 11.75 28.125 13.4289 28.125 15.5C28.125 17.5711 29.8039 19.25 31.875 19.25Z" fill="white" />
                                                    <path d="M7.5 30.5C7.5 31.5275 8.34 32.375 9.375 32.375H35.625C36.66 32.375 37.5 31.5425 37.5 30.5C37.5 27.9425 34.335 24.875 32.8125 24.875C31.29 24.875 29.91 26.75 26.25 26.75C21.6713 26.75 18.75 17.375 15 17.375C11.25 17.375 7.5 25.5538 7.5 30.5Z" fill="white" />
                                                </svg>
                                                Insert banner image
                                            </button>
                                        </div>
                                ...
                                <div className="mt-4 text-center">
                                    <button className="py-2 w-60 border-2 border-black rounded-md" onClick={blogPreview}>
                                        Preview Blog
                                    </button>
                                </div>
                            </div>
