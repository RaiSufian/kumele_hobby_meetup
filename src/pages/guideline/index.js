            ...
            <div className="min-h-screen  m-4 font-plus">
                <div className={` rounded-lg ${styleMode ? "bg-black text-white" : "bg-white"}`}>
                    ...
                    <div className="sm:p-5 p-1">
                        <div className={`_border rounded-lg sm:w-[660px] w-full p-1 relative ${styleMode ? "bg-[#454545] text-white" : "bg-[#E3E3E3]"} `}>
                            ...
                            <div className={`h-10 w-1/3 ${styleMode ? "bg-black" : "bg-white"} absolute top-1 ${guide == 0 ? 'left-1' : ''} ${guide == 1 ? 'left-1/2 -translate-x-1/2' : ''}  ${guide == 2 ? 'right-1' : ''}  rounded-lg transition-all duration-75 ease-in`}></div>
                        </div>
