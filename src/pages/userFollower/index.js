...
const UserFollower = () => {
    ...
    return (
        <Dashboardlayout>
            <div className="md:mx-10 mx-2 my-5 bg-white rounded-lg">
                ...
                <div className="md:p-8 p-3">
                    <div className="bg-light_border rounded-lg sm:w-96 w-72 p-1 relative">
                        ...
                        <div className={`sm:h-11 h-9 w-1/2 bg-white absolute top-1 ${pageName == "Followers" ? 'left-1' : 'right-1'} rounded-lg transition-all duration-75 ease-in`}></div>
                    </div>
                    <div className="mt-5">
                        {pageName == "Followers" ? <>{
