    ...
    const subscript1 = [
        {
            ...
            icons: <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">
                <path d="M23.4615 16.7952C23.0349 16.7952 22.6082 16.6319 22.2832 16.3069C21.6315 15.6552 21.6315 14.6019 22.2832 13.9502L23.4615 12.7719C24.0915 12.1419 24.9282 11.7952 25.8182 11.7952H26.7949C26.7949 9.95691 28.2899 8.46191 30.1282 8.46191V6.79525C30.1282 4.95691 31.6232 3.46191 33.4615 3.46191H35.1282C36.0482 3.46191 36.7949 4.20691 36.7949 5.12858C36.7949 6.05025 36.0482 6.79525 35.1282 6.79525H33.4615V8.46191C33.4615 10.3002 31.9665 11.7952 30.1282 11.7952C30.1282 13.6336 28.6332 15.1286 26.7949 15.1286H25.8182L24.6399 16.3069C24.3149 16.6319 23.8882 16.7952 23.4615 16.7952Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path opacity="0.35" d="M24.6198 27.3034L12.9531 15.6367C12.3014 14.985 11.2481 14.985 10.5964 15.6367C10.0298 16.2034 9.98642 17.0634 10.4081 17.71L5.28642 31.7567C4.55642 33.7584 6.49809 35.7 8.49976 34.97L22.5481 29.8484C22.8231 30.0284 23.1264 30.1484 23.4431 30.1484C23.8698 30.1484 24.2964 29.985 24.6214 29.66C25.2698 29.01 25.2698 27.955 24.6198 27.3034Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path d="M29.2954 36.7949C30.6761 36.7949 31.7954 35.6756 31.7954 34.2949C31.7954 32.9142 30.6761 31.7949 29.2954 31.7949C27.9147 31.7949 26.7954 32.9142 26.7954 34.2949C26.7954 35.6756 27.9147 36.7949 29.2954 36.7949Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path d="M35.9614 18.4619C37.3421 18.4619 38.4614 17.3426 38.4614 15.9619C38.4614 14.5812 37.3421 13.4619 35.9614 13.4619C34.5807 13.4619 33.4614 14.5812 33.4614 15.9619C33.4614 17.3426 34.5807 18.4619 35.9614 18.4619Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path d="M5.96143 15.1284C7.34214 15.1284 8.46143 14.0091 8.46143 12.6284C8.46143 11.2477 7.34214 10.1284 5.96143 10.1284C4.58071 10.1284 3.46143 11.2477 3.46143 12.6284C3.46143 14.0091 4.58071 15.1284 5.96143 15.1284Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path d="M24.2954 6.79492C25.6761 6.79492 26.7954 5.67563 26.7954 4.29492C26.7954 2.91421 25.6761 1.79492 24.2954 1.79492C22.9147 1.79492 21.7954 2.91421 21.7954 4.29492C21.7954 5.67563 22.9147 6.79492 24.2954 6.79492Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path d="M10.9598 3.46191C9.57976 3.46191 8.46143 4.58191 8.46143 5.96191C8.46143 7.34191 9.58143 8.46191 10.9614 8.46191H12.2764C13.8514 8.46191 15.1281 9.73858 15.1281 11.3136V13.4619C15.1281 14.3819 15.8748 15.1286 16.7948 15.1286C17.7148 15.1286 18.4614 14.3819 18.4614 13.4619V10.1286C18.4614 6.44691 15.4764 3.46191 11.7948 3.46191H10.9598Z" fill={` ${styleMode ? "white": "black"}`}  />
                <path d="M36.7951 27.6301C36.7951 29.0101 35.6751 30.1284 34.2951 30.1284C32.9151 30.1284 31.7951 29.0084 31.7951 27.6284V26.3134C31.7951 24.7384 30.5184 23.4618 28.9434 23.4618H26.7951C25.8751 23.4618 25.1284 22.7151 25.1284 21.7951C25.1284 20.8751 25.8751 20.1284 26.7951 20.1284H30.1284C33.8101 20.1284 36.7951 23.1134 36.7951 26.7951V27.6301Z" fill={` ${styleMode ? "white": "black"}`}  />
            </svg>,
            price: 7.07,
    ...
    const subscript2 = [
        {
            ...
            icons: <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">
                <g clip-path="url(#clip0_1_3434)">
                    <path d="M30.1287 10.1284H26.7954V15.1284H30.1287V10.1284Z" fill={` ${styleMode ? "white": "black"}`}  />
                    <path d="M20.1287 10.1284H16.7954V15.1284H20.1287V10.1284Z" fill={` ${styleMode ? "white": "black"}`}  />
                    <path d="M31.7948 11.7952H15.1281C14.2064 11.7952 13.4614 11.0486 13.4614 10.1286C13.4614 9.20858 14.2064 8.46191 15.1281 8.46191H31.7948C32.7164 8.46191 33.4614 9.20858 33.4614 10.1286C33.4614 11.0486 32.7164 11.7952 31.7948 11.7952Z" fill={` ${styleMode ? "white": "black"}`}  />
                    <path d="M36.7951 33.4619C35.8734 33.4619 35.1284 32.7152 35.1284 31.7952V15.1286C35.1284 14.2086 35.8734 13.4619 36.7951 13.4619C37.7168 13.4619 38.4618 14.2086 38.4618 15.1286V31.7952C38.4618 32.7152 37.7168 33.4619 36.7951 33.4619Z" fill={` ${styleMode ? "white": "black"}`}  />
                    <path d="M38.4621 25.1283C39.3826 25.1283 40.1287 24.3821 40.1287 23.4616C40.1287 22.5411 39.3826 21.7949 38.4621 21.7949C37.5416 21.7949 36.7954 22.5411 36.7954 23.4616C36.7954 24.3821 37.5416 25.1283 38.4621 25.1283Z" fill={` ${styleMode ? "white": "black"}`}  />
                    <path opacity="0.35" d="M38.4234 22.6433C38.0101 18.3099 34.1234 15.1283 29.7701 15.1283H26.7951V18.2833C26.7951 19.9433 25.6601 21.4833 24.0218 21.7499C21.9334 22.0883 20.1284 20.4866 20.1284 18.4616C20.1284 17.8516 20.1284 15.1283 20.1284 15.1283H16.7951L10.1284 18.4616L6.25008 13.3083C5.65508 12.3983 4.63008 11.7949 3.46175 11.7949C1.62008 11.7949 0.128418 13.2866 0.128418 15.1283C0.128418 15.3699 0.156751 15.6033 0.205085 15.8299L0.898418 22.7849C1.40675 27.8999 5.71008 31.7949 10.8484 31.7949H30.1284C35.0001 31.7949 38.8967 27.6133 38.4234 22.6433Z" fill={` ${styleMode ? "white": "black"}`}  />
                </g>
                <defs>
        ...
        <>
            < Dashboardlayout>
                <div className="min-h-screen  px-4 mt-5">
                    ...
                    <div className={`mt-5 lg:pr-10 transition-all duration-700 ease-in ${shop == "sub" ? "block" : "hidden"}`}>
                    ...
                    <div className={`mt-5 lg:pr-10 transition-all duration-700 ease-in ${shop == "guest" ? "block" : "hidden"}`}>
