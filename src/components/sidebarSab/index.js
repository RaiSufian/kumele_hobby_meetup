...
const SidebarSub = () => {
    ...
    const [noteDate, setNoteDete] = useState(false);
    return (
        <>
                ...
                <div className="text-end">
                    ...
                    <ul className="mt-5">
                        {list.map((value, index) => {
                            return (
                                <li className="flex gap-3 py-2 cursor-pointer" key={index} onClick={() => setNoteDete(true)}>
            ...
            {noteDate ? <NotiDetailsCard setNoteDete={setNoteDete} /> : null}
        </>
    )
}
