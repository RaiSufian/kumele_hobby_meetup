                            ...
                            <li className="flex items-center justify-between py-3 cursor-pointer" onClick={() => setvalue(2)}>
                                <div className="flex gap-2 items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 40 40" fill="none">
                                        <path opacity="0.35" d="M29.999 35.0003H9.99902C7.23736 35.0003 4.99902 32.762 4.99902 30.0003V16.667C4.99902 13.9053 7.23736 11.667 9.99902 11.667H29.999C32.7607 11.667 34.999 13.9053 34.999 16.667V30.0003C34.999 32.762 32.7607 35.0003 29.999 35.0003Z" fill={` ${styleMode ? "white" : "black"}`} />
                                        <path d="M13.3324 11.667C13.3324 7.98533 16.3174 5.00033 19.999 5.00033C23.6807 5.00033 26.6657 7.98533 26.6657 11.667H29.999C29.999 6.14366 25.5224 1.66699 19.999 1.66699C14.4757 1.66699 9.99902 6.14366 9.99902 11.667H13.3324Z" fill={` ${styleMode ? "white" : "black"}`} />
                                        <path d="M19.999 25.833C21.3797 25.833 22.499 24.7137 22.499 23.333C22.499 21.9523 21.3797 20.833 19.999 20.833C18.6183 20.833 17.499 21.9523 17.499 23.333C17.499 24.7137 18.6183 25.833 19.999 25.833Z" fill={` ${styleMode ? "white" : "black"}`} />
                                        <path d="M28.333 25.833C29.7137 25.833 30.833 24.7137 30.833 23.333C30.833 21.9523 29.7137 20.833 28.333 20.833C26.9523 20.833 25.833 21.9523 25.833 23.333C25.833 24.7137 26.9523 25.833 28.333 25.833Z" fill={` ${styleMode ? "white" : "black"}`} />
                                        <path d="M11.666 25.833C13.0467 25.833 14.166 24.7137 14.166 23.333C14.166 21.9523 13.0467 20.833 11.666 20.833C10.2853 20.833 9.16602 21.9523 9.16602 23.333C9.16602 24.7137 10.2853 25.833 11.666 25.833Z" fill={` ${styleMode ? "white" : "black"}`} />
                                    </svg>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 34 34" fill="none">
                                    <path opacity="0.35" d="M19.7185 14.0727C18.9097 14.8815 10.8658 22.9254 10.057 23.7342C8.43935 25.3518 8.43935 27.9729 10.057 29.5905C11.6746 31.2081 14.2956 31.2081 15.9132 29.5905C16.722 28.7817 24.766 20.7378 25.5748 19.929C27.1924 18.3113 27.1924 15.6903 25.5748 14.0727C23.9572 12.4551 21.3347 12.4551 19.7185 14.0727Z" fill={` ${styleMode ? "white" : "black"}`} />
