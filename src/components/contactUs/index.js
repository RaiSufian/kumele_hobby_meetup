...
const ContactUs = ({ content, setContent }) => {
    ...
    return (
        <div className={`font-plus w-full  h-screen ${styleMode  ? "bg-white" : "bg-black "} bg-opacity-20 fixed top-0 left-0 z-50 flex items-center justify-center ${content ? " block" : "hidden"}`}>
            <div>
                <div className={` ${styleMode  ? "bg-white border-light_border" : "bg-white border-light_border"}  px-4 py-3  rounded-t-2xl relative border-b  `}>
                    ...
                    <div className="sm:w-[440px] w-[350px]">
                        <form>
                            ...
                            <div className="mt-2 text-sm">
                                Comment
                                <div>
                                    <textarea className={` ${styleMode ? "bg-bg_dark" : "bg-bg_light"} mt-1  w-full rounded-md custom_input 1`} rows={6}>
                                    </textarea>
                                </div>
                            </div>
