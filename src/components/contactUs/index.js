const ContactUs = ({ content, setContent }) => {
    return (
        <div className={`font-plus w-full  h-screen bg-black bg-opacity-20 fixed top-0 left-0 z-50 flex items-center justify-center ${content ? " block" : "hidden"}`}>
            <div>
                <div className=" bg-white px-4 py-3  rounded-t-2xl relative border-b border-[#EEECEC]">
                    <div className="w-[440px] cursor-pointer">
                ...
                <div className=" bg-white px-4 py-4  rounded-b-2xl relative border-b border-[#EEECEC]">
                    <div className="w-[440px]">
                        <form>
                            ...
                            <div className="mt-1 text-right">
                                <button className="bg-black text-white py-2 px-16 rounded-lg text-sm">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
