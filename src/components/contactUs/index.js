const ContactUs = ({ content, setContent }) => {
    return (
        <div className={`font-plus w-full  h-screen bg-black bg-opacity-20 fixed top-0 left-0 z-50 flex items-center justify-center ${content ? " block" : "hidden"}`}>
            <div>
                <div className=" bg-white px-4 py-3  rounded-t-2xl relative border-b border-light_border">
                ...
                <div className=" bg-white px-4 py-4  rounded-b-2xl relative border-b border-light_border">
