...
const NotiCard = () => {
    ...
    return (
        <>
            ...
            <div className={` ${styleMode ? "border-[#6B6B6B]" : "border-light_border"} border  rounded-md px-3 py-4 font-plus cursor-pointer relative group hover:bg-[#F0F0F0]`} onClick={()=>setNoteDete(true)}>
                ...
                <div className="absolute bottom-2 right-2 hidden group-hover:block">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="19" viewBox="0 0 26 28" fill="none">
                        <g clip-path="url(#clip0_416_10701)">
                            <path opacity="0.35" d="M19.2103 27.5091H5.87695C3.66762 27.5091 1.87695 25.7184 1.87695 23.5091V6.17578H23.2103V23.5091C23.2103 25.7184 21.4196 27.5091 19.2103 27.5091Z" fill="black" />
                            <path d="M17.8757 3.51042H7.20898V2.17708C7.20898 1.44108 7.80632 0.84375 8.54232 0.84375H16.5423C17.2783 0.84375 17.8757 1.44108 17.8757 2.17708V3.51042Z" fill="black" />
                            <path d="M21.8763 2.17578C21.075 2.17578 4.01097 2.17578 3.20964 2.17578C1.7363 2.17578 0.542969 3.36911 0.542969 4.84245C0.542969 6.31578 1.7363 7.50911 3.20964 7.50911C4.01097 7.50911 21.075 7.50911 21.8763 7.50911C23.3496 7.50911 24.543 6.31578 24.543 4.84245C24.543 3.36911 23.3496 2.17578 21.8763 2.17578Z" fill="black" />
                        </g>
                        <defs>
