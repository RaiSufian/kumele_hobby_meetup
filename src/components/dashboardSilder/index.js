...
const DashboardSlider = ({ setSlide }) => {
    ...
    return (
        <>
            <div className="md:w-[450px] w-[320px] bg-white md:p-8 p-4 rounded-3xl relative text-center animate-fadeIn duration-1000 ease-in-out">
                ...
                <Slider {...settings}>
                    <div>
                        ...
                        <div className="md:py-9 py-5 text-center">
                        ...
                        <button className="font-plus text-lg text-white bg-black mx-auto w-48 h-12 rounded-lg">Create Event</button>
                    </div>
                    <div>
                        ...
                        <button className="font-plus text-lg text-white bg-black mx-auto w-48 h-12 rounded-lg">Invite Friends</button>
                    </div>
                    <div>
                        <div className="home_pop1 w-28 h-28 mx-auto"></div>
                        <div className="md:py-9 py-5 text-center">
                        ...
                        <button className="font-plus text-lg text-white bg-black mx-auto w-48 h-12 rounded-lg">Read Blog</button>
                    </div>
                </Slider>
