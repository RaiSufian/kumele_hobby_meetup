...
const DashboardSlider = ({ setSlide }) => {
    ...
    return (
        <>
            <div className={` ${styleMode ? "bg-black" : "bg-white"} md:w-[450px] w-[320px] bg-white md:p-8 p-4 rounded-3xl relative text-center animate-fadeIn duration-1000 ease-in-out `}>
