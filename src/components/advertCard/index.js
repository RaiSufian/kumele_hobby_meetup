...
const AdvertCard = () => {
    ...
    return (
        <>
            ...
            <div className={` ${styleMode ? "border-[#6B6B6B]" : "border-light_border"} border  rounded-md px-3 py-4 font-plus cursor-pointer relative group hover:bg-[#F0F0F0]`} onClick={()=>setShowAd(true)}>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <p className="flex gap-1 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="31" height="30" viewBox="0 0 45 44" fill="none">
                                    ...
                                    <path opacity="0.35" d="M27.4004 29.9664L14.6442 17.2102C13.9317 16.4976 12.78 16.4976 12.0674 17.2102C11.4478 17.8298 11.4005 18.7701 11.8615 19.4771L6.26154 34.8356C5.46336 37.0242 7.58636 39.1472 9.77496 38.349L25.1353 32.7491C25.4359 32.9459 25.7676 33.0771 26.1138 33.0771C26.5804 33.0771 27.0469 32.8985 27.4022 32.5431C28.1111 31.8324 28.1111 30.6789 27.4004 29.9664Z" fill="black" />
                                    <path d="M32.5108 40.3459C34.0205 40.3459 35.2443 39.122 35.2443 37.6124C35.2443 36.1027 34.0205 34.8789 32.5108 34.8789C31.0012 34.8789 29.7773 36.1027 29.7773 37.6124C29.7773 39.122 31.0012 40.3459 32.5108 40.3459Z" fill="black" />
                                    <path d="M39.8018 20.299C41.3115 20.299 42.5353 19.0752 42.5353 17.5655C42.5353 16.0558 41.3115 14.832 39.8018 14.832C38.2922 14.832 37.0684 16.0558 37.0684 17.5655C37.0684 19.0752 38.2922 20.299 39.8018 20.299Z" fill="black" />
                                    <path d="M6.9991 16.6544C8.50875 16.6544 9.73257 15.4306 9.73257 13.921C9.73257 12.4113 8.50875 11.1875 6.9991 11.1875C5.48944 11.1875 4.26562 12.4113 4.26562 13.921C4.26562 15.4306 5.48944 16.6544 6.9991 16.6544Z" fill="black" />
                                    <path d="M27.044 7.54116C28.5537 7.54116 29.7775 6.31735 29.7775 4.80769C29.7775 3.29804 28.5537 2.07422 27.044 2.07422C25.5344 2.07422 24.3105 3.29804 24.3105 4.80769C24.3105 6.31735 25.5344 7.54116 27.044 7.54116Z" fill="black" />
                                    <path d="M12.4641 3.89844C10.9552 3.89844 9.73242 5.12303 9.73242 6.63191C9.73242 8.14079 10.957 9.36538 12.4659 9.36538H13.9037C15.6258 9.36538 17.0217 10.7613 17.0217 12.4834V14.8323C17.0217 15.8382 17.8381 16.6546 18.844 16.6546C19.8499 16.6546 20.6663 15.8382 20.6663 14.8323V11.1877C20.6663 7.1622 17.4025 3.89844 13.3771 3.89844H12.4641Z" fill="black" />
