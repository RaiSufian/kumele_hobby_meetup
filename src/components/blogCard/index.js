...
const BlogCard = () => {
    ...
    return (
        < Link to={`/blogs/singleton of Glen Ord 38-year old and the Singleton range`}>
            <div className={`${ styleMode ? "bg-black" : "bg-white"} p-2 rounded-2xl flex gap-2`}>
                <div>
                    <img src="/img/blog_pro.png" alt="img" />
                </div>
                <div>
                    <h2 className={` ${styleMode ? "text-black" : ""} sm:text-lg font-plus `}>Singleton of Glen Ord 38-year old and the Singleton range.</h2>
