...
const BlogsSlider = ({ setEvent }) => {
    ...
    return (
        <div className={`${styleMode ? "bg-black" : "bg-white "}rounded-md px-4 py-4 relative `}>
            <h2 className={` ${styleMode ? "text-black" : "" } text-xl font-bold font-plus`}> Hobby events in your location</h2>
            ...
            <div className={` cursor-pointer w-7 h-7 rounded-xl button_shadow flex items-center justify-center absolute top-1/2 left-0 z-10 ${styleMode ? "bg-black" : "bg-white"}  translate-y-2 translate-x-1 `}>
            ...
            <div className={` cursor-pointer w-7 h-7 rounded-xl button_shadow flex items-center justify-center absolute top-1/2 right-0 z-10 ${styleMode ? "bg-black" : "bg-white"} translate-y-2 -translate-x-1 `}>
