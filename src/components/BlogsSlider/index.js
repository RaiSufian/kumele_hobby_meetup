...
const BlogsSlider = ({ setEvent }) => {
    ...
    return (
        <div className={`${styleMode ? "bg-black" : "bg-white "} rounded-md px-4 py-4 relative `}>
            <h2 className={` ${styleMode ? "text-white" : "" } text-xl font-bold font-plus`}> Hobby events in your location</h2>
