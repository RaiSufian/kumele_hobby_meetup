                ...
                <div className={`md:h-[400px] h-[350px]  relative overflow-y-auto  custom_scroll`}>
                    ...
                    <div className="py-1 pb-6">
                        ...
                        <div className="text-start py-2">
                            ...
                            <div className="md:flex item-center justify-between mt-1">
                            ...
                            <div className="mt-7">
                            <h5 className={`text-xl ${styleMode ? "text-white" :""}`}>Comments</h5>
                        
                            <ul className="mt-3">
                                <li className="mt-4 sm:flex gap-2 items-center">
                                    <img src="/img/user-1.png" alt="user_profile" className="w-14 h-14 rounded-full" />
                                    <div>
                                        <span className={`${styleMode ? " text-white" : "text-black "} lg:text-lg font-plus font-medium `}>Josh Durrant • <span className="text-base font-normal"> 23 August, 2022  </span>• <span className='text-theme_blue'> reply</span> </span>
                                        <p className={` ${styleMode ? "text-[#BCBCBC]" : "text-light_text "} text-sm `}>What a display  dsn  cdn zxnc nzc njzcn nzcjcnzjncjcnzjcnzc ncnz cjkznkcnzc kcnznczn cznzxnc  czc znc zncznc z nzcxnjcc ncjcnz nc nzcnnz cc </p>
                                    </div>
                                </li>
                                <li className="mt-4 sm:flex gap-2 items-center">
                                    <img src="/img/user-1.png" alt="user_profile" className="w-14 h-14 rounded-full" />
