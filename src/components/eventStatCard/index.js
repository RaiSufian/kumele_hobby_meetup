                ...
                <div className="flex-1">
                    <div className="flex justify-between items-center">
                        ...
                        <p className="flex gap-1 items-center">
                            ...
                            <span className="text-[#262626] text-lg">Psychedelic</span>
                        </p>
                    </div>
                    <p className="text-[#262626] ">Hosted by Alkesh Kumar</p>
                    <span className="text-[#262626] text-sm">23 August, 2022, 12:40</span>
                </div>
